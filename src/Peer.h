...
public:
  ...
  uint64_t getConnectedDuration() const { return connectedDuration_; }

  void addConnectedDuration(uint64_t seconds) { connectedDuration_ += seconds; }
