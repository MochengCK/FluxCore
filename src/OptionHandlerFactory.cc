...
// BitTorrent Specific Options
  ...
  {
    OptionHandler* op(new BooleanOptionHandler(PREF_ENABLE_UPNP,
                                               TEXT_ENABLE_UPNP, A2_V_TRUE,
                                               OptionHandler::OPT_ARG));
    op->addTag(TAG_BITTORRENT);
    op->setInitialOption(true);
    op->setChangeGlobalOption(true);
  ...
  {
    OptionHandler* op(new DefaultOptionHandler(
        PREF_BT_IP_BAN_LIST, TEXT_BT_IP_BAN_LIST, NO_DEFAULT_VALUE,
        "IP address,..."));
    op->addTag(TAG_BITTORRENT);
    op->setInitialOption(true);
    op->setChangeGlobalOption(true);
  ...
  {
    OptionHandler* op(new BooleanOptionHandler(
        PREF_BT_AUTO_BAN_PEER, NO_DESCRIPTION, A2_V_TRUE,
        OptionHandler::OPT_ARG));
    op->addTag(TAG_BITTORRENT);
    op->setInitialOption(true);
    op->setChangeGlobalOption(true);
  ...
  {
    OptionHandler* op(new BooleanOptionHandler(
        PREF_BT_AUTO_BAN_BAD_DATA, NO_DESCRIPTION, A2_V_TRUE,
        OptionHandler::OPT_ARG));
    op->addTag(TAG_BITTORRENT);
    op->setInitialOption(true);
    op->setChangeGlobalOption(true);
  ...
  {
    OptionHandler* op(new BooleanOptionHandler(
        PREF_BT_AUTO_BAN_ZERO_PROGRESS, NO_DESCRIPTION, A2_V_TRUE,
        OptionHandler::OPT_ARG));
    op->addTag(TAG_BITTORRENT);
    op->setInitialOption(true);
    op->setChangeGlobalOption(true);
  ...
  {
    OptionHandler* op(new BooleanOptionHandler(
        PREF_BT_AUTO_BAN_SNUBBING, NO_DESCRIPTION, A2_V_TRUE,
        OptionHandler::OPT_ARG));
    op->addTag(TAG_BITTORRENT);
    op->setInitialOption(true);
    op->setChangeGlobalOption(true);
  ...
  }
  {
    ...
    // Azureus-style peer ID prefix: -XCVVVV0-
    // XC = XferCore, VVVV = version (major, minor*10, micro)
    char prefix[21];
    snprintf(prefix, sizeof(prefix), "-XC%d%d%d0-",
             major, minor, micro);
