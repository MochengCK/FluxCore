...
public:
  static const char* getMethodName() { return "aria2.banPeer"; }
};

class UnbanPeerRpcMethod : public RpcMethod {
protected:
  virtual std::unique_ptr<ValueBase> process(const RpcRequest& req,
                                             DownloadEngine* e) CXX11_OVERRIDE;
...
class GetTrackersRpcMethod : public RpcMethod {
protected:
  virtual std::unique_ptr<ValueBase> process(const RpcRequest& req,
                                             DownloadEngine* e) CXX11_OVERRIDE;

public:
  static const char* getMethodName() { return "aria2.getTrackers"; }
};
#endif // ENABLE_BITTORRENT
...
class GetBtLevelRpcMethod : public RpcMethod {
protected:
  virtual std::unique_ptr<ValueBase> process(const RpcRequest& req,
                                             DownloadEngine* e) CXX11_OVERRIDE;

public:
  static const char* getMethodName() { return "aria2.getBtLevel"; }
};

class SetBtStatisticsRpcMethod : public RpcMethod {
protected:
  virtual std::unique_ptr<ValueBase> process(const RpcRequest& req,
                                             DownloadEngine* e) CXX11_OVERRIDE;

public:
  static const char* getMethodName() { return "aria2.setBtStatistics"; }
};
#endif // ENABLE_BITTORRENT
